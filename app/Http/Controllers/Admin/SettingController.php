...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'success_color' => 'required|string|max:16',
            'warning_color' => 'required|string|max:16',
            'danger_color' => 'required|string|max:16',
            'info_color' => 'required|string|max:16',
            'default_check_interval' => 'required|integer|min:1',
            'default_timeout' => 'required|integer|min:1',
            'min_check_interval' => 'required|integer|min:1',
            'max_check_interval' => 'required|integer|min:1',
            'uptime_calculation_days' => 'required|integer|min:1',
            'incident_retention_days' => 'required|integer|min:1',
            'discord_webhook_url' => 'nullable|url|max:255',
            'auto_refresh_interval' => 'required|integer|min:1',
